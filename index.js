...
function pixCadastrado(qtd) { return pixTabela.get(String(Number(qtd || 0))) || ''; }
...
app.get('/api/pix-tabela', (req, res) => {
  ...
  res.json({ sucesso: true, itens, limite: CONFIG.limitePixAutomatico });
});
