...
function respostaQuantidade(qtd) {
  const total = moeda(qtd * CONFIG.bilheteValor);
  return `Perfeito! 🎟️
...
app.listen(PORT, () => console.log('Reino Zap PRO V17.5.6 rodando na porta ' + PORT));
